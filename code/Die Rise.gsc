...
init()
{
    if ( isdefined(mapname) && mapname == "zm_highrise" )
	{
...
init_custom_map()
{
	//perk machine building1top
	perk_system( "script_model", ( 1100.47, 2713.98, 3048.52 ), "zombie_vending_nuke_on_lo", ( 0,  45, 0 ), "random", "mus_perks_jugganog_sting", "Random Perk", 2500, "doubletap_light" );
    //perk machine redroom
	perk_system( "script_model", ( 3000.95, 1837.7, 1440.5 ), "zombie_vending_nuke_on_lo", ( 0, -90, 0 ), "random", "mus_perks_jugganog_sting", "Random Perk", 2500, "jugger_light" );
}
...
give_random_perk()
{
   ...
   if(!self hasPerk("specialty_armorvest"))
    ...
    perk = n[0];
    if(perk == "specialty_armorvest" || perk == "specialty_rof" || perk == "specialty_fastreload" || perk == "specialty_longersprint" || perk == "specialty_quickrevive" || perk == "specialty_scavenger" || perk == "specialty_additionalprimaryweapon"|| perk == "specialty_flakjacket")
	{
