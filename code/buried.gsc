...
init()
{
    if ( isdefined(mapname) && mapname == "zm_buried" )
	{
...
{
	//perk machine maze
	perk_system( "script_model", ( 6862, 846, 108 ), "zombie_vending_jugg", ( 0, 49, 0 ), "random", "mus_perks_jugganog_sting", "Random Perk", 2500, "doubletap_light" );
    //perk machine 
        ...
        foreach( player in level.players )
        {
            if(!player.machine_is_in_use)
			{
                if( distance( self.origin, player.origin ) <= 70 )
                {
					...
					if( type == "random" && !player.num_perks > 16 && player usebuttonpressed() && ( player.score >= cost ) && !player maps/mp/zombies/_zm_laststand::player_is_in_laststand())
					{
					...
					if(type == "random" && player.num_perks > 16 && player usebuttonpressed() && ( player.score >= cost ) )
					{
...
drawshader_and_shadermove(perk, custom, print)
{
	 ...
	 for(i = 0; i < self.perkarray.size; i++)
	{
        ...
        if(perk == "Downers_Delight")
        {
            ...
            self.perk1front = self drawshader( "waypoint_revive", x, -40, 23, 23, ( 2, 2, 2 ), 100, 0 ); 
        ...
        {   
            ...
            self.perk2front = self drawshader( "menu_mp_weapons_1911", x, -40, 22, 22, ( 5, 3, 5 ), 100, 0 );
        ...
        {    
            ...
            self.perk3front = self drawshader( "hud_icon_sticky_grenade", x, -40, 23, 23, ( 6, 6, 1 ), 100, 0 );
        ...
        {    
            ...
            self.perk4front = self drawshader( "zombies_rank_2", x, -40, 23, 23, ( 8, 8, 8 ), 100, 0 );
        ...
        {    
            ...
            self.perk5front = self drawshader( "zombies_rank_5", x, -40, 23, 23, ( 9, 9, 9 ), 100, 0 );
        ...
        {    
            ...
            self.perk6front = self drawshader( "zombies_rank_3", x, -40, 23, 23, ( 4, 4, 4 ), 100, 0 );
        ...
        {    
            ...
            self.perk7front = self drawshader( "zombies_rank_4", x, -40, 23, 23, ( 1, 4, 1 ), 100, 0 );
		...
		if(perk == "Ammo_Regen")
        {
            ...
            self.perk8front = self drawshader( "menu_mp_lobby_icon_customgamemode", x, -40, 23, 23, ( 1, 4, 1 ), 100, 0 );
        ...
        if(perk == "Dying_Wish")
        {
            ...
            self.perk10front = self drawshader( "zombies_rank_5", x, -40, 23, 23, ( 1, 6, 1 ), 100, 0 );
...
give_random_perk()
{
   ...
   if(!self hasPerk("specialty_armorvest"))
    ...
    perk = n[0];
    if(perk == "specialty_armorvest" || perk == "specialty_rof" || perk == "specialty_fastreload" || perk == "specialty_longersprint" || perk == "specialty_quickrevive" || perk == "specialty_scavenger"|| perk == "specialty_nomotionsensor"|| perk == "specialty_additionalprimaryweapon")
	{
