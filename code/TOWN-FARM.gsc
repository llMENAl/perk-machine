...
{
	//perk machine town
	perk_system( "script_model", (  1823.86, 670.574, -55.875 ), "zombie_vending_jugg_on", ( 0, 45, 0 ), "random", "mus_perks_deadshot_sting", "Random Perk", 1500, "sleight_light" );
	//perk machine Farm
	perk_system( "script_model", (   8371, -5408, 264 ), "zombie_vending_jugg_on", (  0, 180, 0 ), "random", "mus_perks_deadshot_sting", "Random Perk", 1500, "sleight_light" );
    //perk machine bus depot not working 
	//perk_system( "script_model", (   -6706, 5016, -56 ), "zombie_vending_jugg_on", (  0, 180, 0 ), "random", "", "Random Perk", 1500, "sleight_light" );
}
...
drawshader_and_shadermove(perk, custom, print)
{
    ...
    for(i = 0; i < self.perkarray.size; i++)
	{
        ...
        if(perk == "deadshot")
        {
            self.perk11back = self drawshader( "specialty_marathon_zombies", x, -40, 24, 24, ( 0, 0, 0 ), 100, 0 );
            self.perk11front = self drawshader( "killiconheadshot", x, -40, 23, 23, ( 1, 1, 1 ), 100, 0 );
