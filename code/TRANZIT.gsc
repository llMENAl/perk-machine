...
init()
{
	...
	{
		if ( GetDvar("customMap") != "tunnel" && GetDvar("customMap") != "diner" && GetDvar("customMap") != "power" && GetDvar("customMap") != "cornfield" && GetDvar("customMap") != "house" && GetDvar("customMap") != "vanilla" )
		{
...
{
	//perk machine diner
	perk_system( "script_model", (  -4590.28, -7539, -62.5062 ), "zombie_vending_jugg_on", ( 0, 270, 0 ), "random", "mus_perks_deadshot_sting", "Random Perk", 1500, "sleight_light" );
    //perk machine power
	perk_system( "script_model", (  11386, 8830, -585 ), "zombie_vending_jugg_on", ( 0,  -35, 0 ), "random", "mus_perks_deadshot_sting", "Random Perk", 1500, "sleight_light" );
    //perk machine cornfield
	perk_system( "script_model", (  13975.1, -1530.29, -189.8062 ), "zombie_vending_jugg_on", (  0, -90, 0), "random", "mus_perks_deadshot_sting", "Random Perk", 1500, "sleight_light" );
    //perk machine tunnel
	perk_system( "script_model", (   -10664, -657, 196 ), "zombie_vending_jugg_on", ( 0, -98, 0 ), "random", "mus_perks_deadshot_sting", "Random Perk", 1500, "sleight_light" );
    //perk machine house
	perk_system( "script_model", (   5022.8, 6592.9, -17.0379 ), "zombie_vending_jugg_on", ( 0, 90, 0 ), "random", "mus_perks_deadshot_sting", "Random Perk", 1500, "sleight_light" );
}
...
drawshader_and_shadermove(perk, custom, print)
{
    ...
    for(i = 0; i < self.perkarray.size; i++)
	{
        ...
        if(perk == "Burn_Heart")
        {
            self.perk9back = self drawshader( "specialty_marathon_zombies", x, -40, 24, 24, ( 200, 0, 0 ), 100, 0 );
            self.perk9front = self drawshader( "faction_cdc", x, -40, 23, 23, ( 1, 1, 1 ), 100, 0 );
