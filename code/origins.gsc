...
init_custom_map()
{
	//perk machine trenches 
	perk_system( "script_model", ( 2468, 4459, -316 ), "p6_zm_vending_diesel_magic", ( 0, 180, 0 ), "random", "mus_perks_jugganog_sting", "Random Perk", 2500, "jugger_light" );
    //perk machine crazyplace
	perk_system( "script_model", ( 9786, -8790.25, -451.75 ), "p6_zm_vending_diesel_magic", ( 0, 180, 0 ), "random", "mus_perks_jugganog_sting", "Random Perk", 2500, "jugger_light" );
}
...
drawshader_and_shadermove(perk, custom, print)
{
	 ...
	 for(i = 0; i < self.perkarray.size; i++)
	{
        ...
        if(perk == "Downers_Delight")
        {
            ...
            self.perk1front = self drawshader( "waypoint_revive", x, -40, 23, 23, ( 4, 4, 4 ), 100, 0 ); 
        ...
        {   
            ...
            self.perk2front = self drawshader( "menu_mp_weapons_1911", x, -40, 22, 22, ( 5, 5, 5 ), 100, 0 );
        ...
        {    
            ...
            self.perk5front = self drawshader( "zombies_rank_5", x, -40, 23, 23, ( 8, 8, 8 ), 100, 0 );
        ...
        {    
            ...
            self.perk7front = self drawshader( "zombies_rank_4", x, -40, 23, 23, ( 5, 5, 5 ), 100, 0 );
		...
		if(perk == "Ammo_Regen")
        {
            ...
            self.perk8front = self drawshader( "menu_mp_lobby_icon_customgamemode", x, -40, 23, 23, ( 4, 4, 4 ), 100, 0 );
        ...
        if(perk == "Dying_Wish")
        {
            ...
            self.perk10front = self drawshader( "zombies_rank_5", x, -40, 23, 23, ( 8, 8, 8 ), 100, 0 );
